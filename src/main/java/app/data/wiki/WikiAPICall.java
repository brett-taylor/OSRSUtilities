...
public class WikiAPICall {
    ...
    /**
     * Constructs and calls an api to the OSRS app.data.wiki.
     * @param api the ending of the api call. The address of the app.data.wiki and /api/v1/Articles/ is inserted automatically.
     */
